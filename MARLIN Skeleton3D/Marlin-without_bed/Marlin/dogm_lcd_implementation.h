...
static void lcd_implementation_init()
{
	...
	do {
			...
			// Welcome message
			u8g.setFont(u8g_font_6x10_marlin);
			u8g.drawStr(62,10,"SKELETON 3D"); 
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(62,19,"V0.9");
			u8g.setFont(u8g_font_6x10_marlin);
			u8g.drawStr(62,28,"by DACO 3D");
			u8g.drawStr(62,41,"");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(62,48,"vous souhaite");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(62,55,"de bonnes");
			u8g.drawStr(62,61,"impressions");
			u8g.drawStr90(92,57,"");
			u8g.drawStr(100,61,"");
	   } while( u8g.nextPage() );
}
